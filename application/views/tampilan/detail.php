...
<body>
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="container d-flex">
                                <div class="pr-2">
                                    <img src="/uploads/default.png" alt="" width="35" height="35"
                        ...
                        <div class="">
                            ...
                            <div class=" pull-right">
                                <button class="next btn btn-info text-light"> <i class="fa fa-arrow-right"></i>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="copyright py-3 text-center">
        <p>© 2019 Grand Tour. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="=_blank">
                W3layouts </a></p>
    </div>
    <!-- //copyright -->
    ...
    <script type="text/javascript" src="/assets/js/jstars.js"></script>
    <script type="text/javascript" src="/assets/js/jstars.min.js"></script>
